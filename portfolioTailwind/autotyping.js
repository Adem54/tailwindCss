...
const exampleText = ['Developer', 'Designer', 'Author'];//autotypingin uygulanacagi textler bunlarda
    const exampleTyping = new AutoTyping('#text', exampleText, {//#text id hangi elemente ait text e uygulayacak isek onun id si
        typeSpeed: 100,
        deleteSpeed: 100,
